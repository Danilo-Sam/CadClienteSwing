...
public class TelaPrincipal<IClienteDAO> extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                ...
                                                .addComponent(txtUF, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (!isCamposValidos(nome, cpf, fone, end, numero, cidade, uf)) {
            JOptionPane.showMessageDialog(null, "Preencher todos os dados!!", "Atenção",
                    JOptionPane.INFORMATION_MESSAGE);
            return;
        }

        if (!cpf.matches("\\d+") || !fone.matches("\\d+") || !numero.matches("\\d+")) {
            JOptionPane.showMessageDialog(null, "CPF, telefone e número devem conter apenas dígitos numéricos.",
                    "Atenção", JOptionPane.INFORMATION_MESSAGE);
            return;
        }

        Cliente cliente = new Cliente(nome, cpf, fone, end, numero, cidade, uf);
        Boolean isCadastrado = ((ClienteMapDAO) this.clienteDAO).cadastrar(cliente);
    ...
    private void tableClientesMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_tableClientesMouseClicked
        ...
        Cliente cliente = ((ClienteMapDAO) this.clienteDAO).consultar(cpf);
    ...
    private void bntExcluirActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bntExcluirActionPerformed
        ...
        if (linhaSelecionada >= 0) {
            ...
            if (result == JOptionPane.YES_OPTION) {
                Long cpf = (Long) tableClientes.getValueAt(linhaSelecionada, 1);
                ((ClienteMapDAO) this.clienteDAO).excluir(cpf);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (linhaSelecionada >= 0 && (txtNome.getText().isEmpty() && txtCPF.getText().isEmpty()
                && txtFone.getText().isEmpty() && txtEnd.getText().isEmpty()
        ...
        if (linhaSelecionada >= 0) {
            ...
            if (telefone.matches("\\d+")) {
                ...
                JOptionPane.showMessageDialog(null, "Telefone inválido! Apenas números são permitidos.", "Erro",
            ...
            if (numero.matches("\\d+")) {
                ...
                JOptionPane.showMessageDialog(null, "Numero inválido! Apenas números são permitidos.", "Erro",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            ((ClienteMapDAO) this.clienteDAO).alterar(cliente);
